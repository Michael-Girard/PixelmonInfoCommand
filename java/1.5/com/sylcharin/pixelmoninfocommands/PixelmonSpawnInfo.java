        ...
        if (tagMap.values().contains(Enums.JSONTag.name)){
            ...
            tagMap.keySet().stream().forEach(key -> {
                if (monMap.keySet().contains(key)){
                    ...
                    pixelmon.getInformation().forEach(spawnSet ->{
                        ...
                        for (String biome : biomeArray){
                            ...
                            biomeRarities.put(biome, Double.valueOf(results.substring(results.indexOf("(", pixelmonIndex) + 3, results.indexOf(")", pixelmonIndex) - 3)));
                        }
                        ...
                        if (biomeRarities.isEmpty()){
                            pixelmonInfo.append("\u00A7aBiomes\u00A7f: \u00A7eAll Biomes");
                        }
                        else{
                    ...
                    for (int index = 0, matches = 0; index < tags.size(); index++) {
                        ...
                        if (tagList != null && currentJSONTag.equals(Enums.JSONTag.stringBiomes) && spawnConditions.containsKey(currentJSONTag.toString())) {
                            ...
                            for (String biome : biomes) {
                                if (biome.equals(tags.get(index))) {
            ...
            if (results.isEmpty()) {
                ...
                pixelmonList.delete(pixelmonList.length() - 2, pixelmonList.length());
                pixelmonList.append(".\n-----------------------------------------------------");
                return pixelmonList;
            }
        }
