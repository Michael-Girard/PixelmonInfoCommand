 ...
 */
class BiomeList {
    private static BiomeList instance = null;
    private static final HashMap<Biomes, String> BIOME_MAP = new HashMap<>();

    public static HashMap<Biomes, String> getBiomeMap(){
        return BIOME_MAP;
    }
    ...
    private static void buildBiomeMap(){
        ...
        BIOME_MAP.put(Biomes.mutated_mesa, "Mesa M");
